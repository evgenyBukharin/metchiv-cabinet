...
/* harmony import */ var _components_tableSlider_hero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/tableSlider-hero */ "./src/js/components/tableSlider-hero.js");
...
/***/ "./src/js/components/tableSlider-hero.js":
/*!***********************************************!*\
  !*** ./src/js/components/tableSlider-hero.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
typeButtons.forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    if (isHeroOnPage) {
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`http://localhost:3000/methchivDataNew?type=${activeTypeButton.innerHTML}`).then(r => {
        sliderData = r.data;
        makeSlider({
          updateSlides: true
        });
...
`;
if (isHeroOnPage) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`http://localhost:3000/methchivData?type=${activeTypeButton.innerHTML}`).then(r => {
    sliderData = r.data;
    makeSlider();
  }).catch(e => {
    console.log(e);
...
function makeSlider() {
  ...
  const sliderBullets = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.hero__container-slider-bullets`), {
    slidesPerView: 3,
    speed: 500,
    spaceBetween: 0
  });
  slider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](document.querySelector(`.hero__slider`), {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 500,
    pagination: {
